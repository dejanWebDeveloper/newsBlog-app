...
Route::get('/category/{category}', [\App\Http\Controllers\PagesController::class, 'category'])->name('category_page');
...
Route::get('/single-page/{article}', [\App\Http\Controllers\PagesController::class, 'singlePage'])->name('single_page');
